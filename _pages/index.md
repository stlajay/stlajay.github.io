...
<div class="wrap-around item-details divider" style="font-family: Apercu;">
 ...
 <section class="job-item">
    <div class="job-details">
        <h3>Microsoft</h3>
        <p>(<a href="https://stlajay.github.io/assets/images/futuremicrosoft/FutureReady.png">Future Ready</a>: Cloud Computing, Machine Learning)</p>
        <h4><i>Winter Intern</i></h4>
        <p>September 2021 – December 2021</p>
    </div>
    <div class="job-summary">
        <p>Top 1000+ <a href="https://1drv.ms/b/s!AjnDsL7q8UJebvVB5MCIljUCyLM?e=TbZxen">performer</a> in Microsoft Azure project development</p>
        <p>Key contributions:</p>
        <ul class="job_list">
...
<div class="wrap-around item-details" style="font-family: Apercu;">
  ...
  <section class="education-wrap">
    <h3>GitHub Education - <i>USA (virtual)</i></h3>
      <p>GitHub's All In Open Source, Software Fellow, January 2023 - April 2023</p>
      <p>Look at Graduation Record: <b class="education-record">AllInOpenSource/All-In-For-Students-Graduation-2023/<a href="https://github.com/AllInOpenSource/All-In-For-Students-Graduation-2023" target="_blank" class="education-record-link">README.md</a></b></p>
      <ul class="education-ul">
        <li>Developed digital presence to reach the community support by making contributions to the GitHub ecosystem.</li>
        <li>Technical communication with peers regarding ways to maximise potential for open sourcing inclusion and diversity.</li>
      </ul>
  </section>
